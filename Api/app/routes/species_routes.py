...
def get_species_list():
    try:
        ...
        return jsonify({'message': 'Erreur base de données sur la liste des espèces.'}), 500
...
def get_species_detail(species_id):
    try:
        ...
        return jsonify({'message': 'Erreur base de données sur le détail espèce.'}), 500
...
def create_species():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'message': "Erreur base de données lors de l'ajout de l'espèce."}), 500
